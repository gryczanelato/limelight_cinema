<?php
  //making connection with db
    ...
    if(isset($_POST['submit_btn'])){
      ...
      $sql = "SELECT * FROM llc_admin WHERE admin_name='$username' AND admin_password='$password'";
      ...
      if ($count == 1) {
        ...
        $_SESSION['adminlogin'] = "admin";
          header("Location:http://webdev.edinburghcollege.ac.uk/~HNCWEBMR19/llc/admin_users.php");
        }
          ...
          <section class="py-5 text-center container wow fadeInLeft">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 id="login" class="fw-regular">Admin login form</h1>
                </div>
            </div>
          </section>
                ...
                <div class="col-lg-12 col-xl-11">
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-10 col-xl-10 order-2 order-lg-1">
                      <form action="loginform_admin.php" class="form-group mx-1 mx-md-1" name="adminloginform" method="POST">
                        ...
                        <div class="card-body d-flex justify-content-center wow fadeIn">
                            <a href="loginform.php#login"><button type="button" class="btn btn-outline-light">Not an admin?</button></a>
                        </div>
