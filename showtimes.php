    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg static-top wow fadeIn" style="background-color:#001018;">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="showtimes.php">Showtimes</a>
                        </li>
                        <li class="nav-item">
        ...
        <main class="home-content">
            ...
            <section class="py-5 text-center container wow fadeInLeft">
                <div class="row py-lg-5">
                    <div class="col-lg-6 col-md-8 mx-auto">
                        <h1 id="whats_on" class="fw-regular">What's on</h1>
                    </div>
                </div>
            </section>
            ...
            <section class="movies-section" id="movies">
                ...
                $sql = "SELECT title, director, description, picture FROM llc_movies";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<h3 class='text-50 mb-0 pb-1'>No movies to show</h3>";
                }
                ?>
